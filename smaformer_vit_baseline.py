...
class SMAFormerBaseline(SMAFormer):
    def __init__(
        ...
        self.vit_branch = ViTBottleneckBranch(
            vit_name=vit_name,
            img_size=img_size,
            target_grid=16,            # matches this SMAFormer's bottleneck grid at 512 input
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        x4 = self.patch_embedding3.PE(x3)  # [B, 256, 512]  (16x16 tokens, matches ViT projection below)
